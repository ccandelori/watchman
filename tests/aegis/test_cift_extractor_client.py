...
def test_cift_http_extractor_returns_validated_provenance_with_feature_extraction() -> None:
    ...
    assert extraction.provenance == {
        ...
        "readout_token_indices": [4, 5, 6],
        "query_tail_readout_token_indices": [4, 5, 6],
        "readout_window_source": "query_tail",
        "readout_source": {"source": "trusted-activation-sidecar", "readout_window": "query_tail", "token_count": 3},
        "selected_choice_readout_token_indices": [7, 8],
